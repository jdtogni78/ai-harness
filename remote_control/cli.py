...
USAGE = "usage: python3 -m remote_control <supervisor|telegram-bridge|manager|manager-ui|perm-gate|install|codex-import|titles|sessions|work|fork|fork-all|resume|new-session|relaunch|takeover|eval> [args]"
